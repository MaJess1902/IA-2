...
if imagen_original is None:
    print("Error: No se encontró la imagen en la ruta especificadas.")
else:
    ...
    # Guardar la imagen ruidosa generada
    cv2.imwrite('1_imagen_ruidosa.png', imagen_ruidosa)
    ...
    # ==========================================
    cv2.imwrite('2_filtro_media.png', filtro_media)
    cv2.imwrite('3_filtro_gaussiano.png', filtro_gaussiano)
    cv2.imwrite('4_filtro_mediana.png', filtro_mediana)

    # ==========================================
    # 4. MATPLOTLIB: VISUALIZACIÓN COMPARATIVA
    # ==========================================
    # Convertimos de BGR a RGB para mostrar correctamente los colores con Matplotlib
    ...
    plt.tight_layout()
    plt.savefig('comparativa_filtros.png')

    print("\n¡Proceso del Taller 4 completado exitosamente!")
    print("Archivos de resultados generados:")
    print(" - '1_imagen_ruidosa.png'")
    print(" - '2_filtro_media.png'")
    print(" - '3_filtro_gaussiano.png'")
    print(" - '4_filtro_mediana.png'")
    print(" - 'comparativa_filtros.png' (Comparativa de los 4 estados)")
...
if imagen_color is None:
    ...
    # ==========================================
    # 3. GUARDAR RESULTADOS (Para Codespaces)
    # ==========================================
    cv2.imwrite('1_imagen_binaria_limpia.png', imagen_limpia)
    cv2.imwrite('2_clasificacion_objetos.png', resultado)
    ...
    plt.tight_layout()
    plt.savefig('panel_clasificacion.png')

    print("\n¡Proceso del Taller 6 completado exitosamente!")
    print("Archivos generados:")
    print(" - '1_imagen_binaria_limpia.png'")
    print(" - '2_clasificacion_objetos.png'")
    print(" - 'panel_clasificacion.png' (Visualización comparativa)")